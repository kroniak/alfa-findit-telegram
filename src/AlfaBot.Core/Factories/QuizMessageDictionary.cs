namespace AlfaBot.Core.Factories
{
    public static class QuizMessageDictionary
    {
        ...
        public const string UniversityMessage = "Укажи свой ВУЗ";
        public const string IsStudentMessage = "Ты еще учишься?";
        public const string CourseMessage = "На каком курсе ты учишься?";
